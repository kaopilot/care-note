...
*Round two of the review — the sixteen clinic scenarios, the twelve-capability
list, what we tried that failed, and which earlier assumptions no longer stand —
is a separate document:* [`BRIEF_ROUND2.md`](BRIEF_ROUND2.md).
