  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        {/* Degraded is not low confidence. Low confidence means the model was
            unsure; degraded means no model read this consult at all, and the
            deterministic summariser wrote it. Before this chip existed the only
            trace was a model string in the 10px provenance footer, which is a
            machine-facing label sitting where a clinician does not look. */}
        {isAi && entry.ai_degraded && (
          <Chip
            tone="alert"
            title="The summarisation model was unreachable. This summary was extracted from the transcript by rule, not generated by a model — sentences are the speakers' own."
          >
            ⚠ Written without the AI — model unavailable
          </Chip>
        )}
